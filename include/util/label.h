...
Description: This file has realized the following functions:
             - defined the map between the animal label and the predict value
*/
...
// the mapping relationship between animal lable and the predict value
// inline：avoid multiple definition error，because the compile will merge the same name
// const：the value of the map will not be changed
inline const std::unordered_map<int, std::string> animalLables{
    {0, "tench, Tinca tinca"},
